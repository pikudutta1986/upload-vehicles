		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var gridOpts = {
				...
				columns: [{text: myLabel.image, type: "text", sortable: false, editable: false, renderer: formatImage, width: 110},
				          {text: myLabel.details, type: "text", sortable: true, editable: false, width: 130},
				          {text: myLabel.owner, type: "text", sortable: true, editable: false, renderer: formatOwner, width: 150},
