...
if (!defined("PJ_TEMPLATE_PATH")) define("PJ_TEMPLATE_PATH", "templates/");
if (!defined("PJ_TEMPLATE_SCRIPT_PATH")) define("PJ_TEMPLATE_SCRIPT_PATH", "default/");
if (!defined("PJ_TEMPLATE_WEBSITE_PATH")) define("PJ_TEMPLATE_WEBSITE_PATH", "website/");

if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "78");
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "3.3");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.3.1");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "carlisting_");
...
if (!defined("PJ_GALLERY_SMALL")) define("PJ_GALLERY_SMALL", "147,110");
if (!defined("PJ_GALLERY_MEDIUM")) define("PJ_GALLERY_MEDIUM", "573,433");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin',  'pjAuthorize', 'pjPaypal', 'pjGallery');
?>