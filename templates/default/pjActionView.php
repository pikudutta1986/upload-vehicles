...
<div id="pjWrapper">
	...
	<h1>For Sale: <!---- ?php echo stripslashes($tpl['arr']['listing_title']); ? -->

					<?php echo stripslashes($tpl['arr']['year']); ?>	<?php echo stripslashes($tpl['arr']['make']); ?> <?php echo stripslashes($tpl['arr']['model']); ?> </h1>	
				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<ul class="list-group">
                             ...
                             <li class="list-group-item clearfix"><span class="pull-left">VIN#</span> <strong class="pull-right"><?php echo stripslashes($tpl['arr']['vin']); ?></strong></li>

								

							<li class="list-group-item clearfix"><span class="pull-left"><?php echo __('front_label_year'); ?></span> <strong class="pull-right"><?php echo stripslashes($tpl['arr']['year']); ?></strong></li>	
...

			{
				...
				<li class="col-md-6">
					...
					<address>
						...
						<a href="https://www.uploadvehicles.com/preview.php?id=<?php echo $tpl['arr']['owner_id']; ?>&controller=pjListings&action=pjActionCars">
							<strong>
								<?php echo join(" ", $name_arr); ?>
							</strong>
						</a>
...

			{
				...
				<li class="col-md-6">
					...
					<address>
						...
						<strong><!------?php echo !preg_match('/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,6}$/i', $tpl['arr']['email']) ? $tpl['arr']['email'] : '<a href="mailto:'.$tpl['arr']['email'].'">'.$tpl['arr']['email'].'</a>'; ? ----> Private</strong>
