...
<html>
	...
	<body>
		<div id="container">
    		<div id="header">
				<div id="logo">
					<a href="https://www.uploadvehicles.com/" target="_blank" rel="nofollow">Auto Buyers Market</a>
		...
		<div id="footer-wrap">
			<div id="footer">
			   	<p>Copyright &copy; <?php echo date("Y"); ?> <a href="https://www.UploadVehicles.com" target="_blank">UploadVehicles.com</a></p>
	        </div>
        </div>
	</body>
</html>